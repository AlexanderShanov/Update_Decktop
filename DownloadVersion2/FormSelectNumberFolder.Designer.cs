namespace DownloadVersion2
{
    partial class FormSelectNumberFolder
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Номер целевой папки на компюторе клиента из списка натроек на его компе";
            // 
            ...
            this.Load += new System.EventHandler(this.FormSelectNumberFolder_Load);
